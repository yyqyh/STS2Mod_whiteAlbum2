            ...
            .AddSection("symbiosis", section => section
                ...
                .AddParagraph(
                    ...
                    ModSettingsText.Literal(
                        ...
                        + "联机时以主机设置为准。"))
                        .AddToggle("pvp_enabled", ModSettingsText.Literal("开启 PVP 决斗"), new ModSettingsValueBinding<PvpSettings, bool>(Const.ModId, PvpSettingsStore.DataKey, SaveScope.Global, s => s.Enabled, (s, v) => s.Enabled = v))
                        .AddToggle("pvp_event", ModSettingsText.Literal("生成对决事件"), new ModSettingsValueBinding<PvpSettings, bool>(Const.ModId, PvpSettingsStore.DataKey, SaveScope.Global, s => s.EventEnabled, (s, v) => s.EventEnabled = v))
                        .AddToggle("debug_master", ModSettingsText.Literal("调试总开关"), new ModSettingsValueBinding<PvpSettings, bool>(Const.ModId, PvpSettingsStore.DataKey, SaveScope.Global, s => s.Debug, (s, v) => s.Debug = v))));
    }
