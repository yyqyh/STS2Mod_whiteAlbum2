...
internal static class TogetherMirrorPatches
{
    ...
    [HarmonyPostfix]
    private static void BlockMirrorPostfix(Creature __instance)
    {
    ...
    [HarmonyPostfix]
    private static void CurrentHpMirrorPostfix(Creature __instance)
    {
        foreach (var other in __instance.OthersOrEmpty())
        {
    ...
    [HarmonyPostfix]
    private static void MaxHpMirrorPostfix(Creature __instance)
    {
        foreach (var other in __instance.OthersOrEmpty())
        {
    ...
    [HarmonyPostfix]
    private static void GoldMirrorPostfix(Player __instance)
    {
    ...
    [HarmonyPostfix]
    private static void LoseGoldMirrorPostfix(Player __1)
    {
    ...
    [HarmonyPostfix]
    private static void PowerAppliedMirrorPostfix(Creature __instance, PowerModel __0)
    {
    ...
    [HarmonyPostfix]
    private static void PowerRemovedMirrorPostfix(Creature __instance, PowerModel __0)
    {
    ...
    [HarmonyPostfix]
    private static void PowerAmountMirrorPostfix(Creature __instance, PowerModel __0, bool __2)
    {
    ...
    [HarmonyPrefix]
    private static bool SecondHitModifyAmountPrefix(PowerModel __1, decimal __2, Creature? __3, ref Task<int> __result)
    {
    ...
    [HarmonyPrefix]
    private static bool SecondHitApplyPrefix(PowerModel __1, Creature __2, decimal __3, Creature? __4, ref Task __result)
    {
