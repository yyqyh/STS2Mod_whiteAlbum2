...
public sealed class ToumaCardOne : ModCardTemplate
{
    public ToumaCardOne() : base(1, CardType.Attack, CardRarity.Basic, TargetType.AnyEnemy)
    {
    }
...
[RegisterCard(typeof(ToumaCardPool))]
[RegisterCharacterStarterCard(typeof(Touma), 5, Order = 20)]
public sealed class ToumaCardTwo : ModCardTemplate
{
    public ToumaCardTwo() : base(1, CardType.Skill, CardRarity.Basic, TargetType.Self)
    {
    }
...
[RegisterCard(typeof(ToumaCardPool))]
public sealed class ToumaCardThree : ModCardTemplate
{
    public ToumaCardThree() : base(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
    {
    }
...
[RegisterCard(typeof(ToumaCardPool))]
public sealed class ToumaCardFour : ModCardTemplate
{
    public ToumaCardFour() : base(1, CardType.Skill, CardRarity.Uncommon, TargetType.Self)
    {
    }
...
[RegisterCard(typeof(ToumaCardPool))]
public sealed class ToumaCardFive : ModCardTemplate
{
    public ToumaCardFive() : base(2, CardType.Attack, CardRarity.Rare, TargetType.AnyEnemy)
    {
    }
